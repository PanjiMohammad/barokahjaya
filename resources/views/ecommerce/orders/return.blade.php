                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('customer.return', $order->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="refund_transfer" placeholder="Masukkan Nominal" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control" required>
                                    <small class="font-weight-bold text-dark">nominal: {{ 'Rp ' . number_format($order->subtotal, 0, ',', '.') }}</small>
                                </div>
                                <div class="form-group">
